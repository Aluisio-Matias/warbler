#to run these tests us: FLASK_ENV=production python -m unittest test_user_views.py
...
# Deactivate WTForms from using CSRF at all, since it's a pain to test
...
class MessageViewTestCase(TestCase):
    ...
    def test_unauthenticated_like(self):
        ...
        with self.client as c:
            ...
            self.assertIn("Your access is unauthorized!", str(resp.data))
